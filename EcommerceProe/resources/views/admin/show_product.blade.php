...
<div class="overflow-auto" style="height: 600px;">
            <table class="center">
                ...
                <tr>
                    ...
                    <td><div style="margin-bottom: 10px;"><a onclick="return confirm('Are You Sure To Delete')" href="{{url('delete_product',$product->id)}}" class="btn btn-danger">Delete</a></div>

                    <div><a onclick="return confirm('Are You Sure To Edit')" href="{{url('update_product',$product->id)}}" class="btn btn-primary">Edit</a></td></div>
                </tr>
