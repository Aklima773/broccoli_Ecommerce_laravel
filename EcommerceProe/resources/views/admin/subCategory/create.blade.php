...
<!-- section start -->
            <div class="div_center">
                <h1 class="h1_font" style="color:white">Add Sub Catagory</h1>

                <form action="{{url('/sub_categories/')}}" method="post"
...
<br>
                        ...
                        <div class="control-group">
                            <label class="control-label" style="color:white">Image Upload</label>
                            <div class="controls">
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-primary" style="color:white">Add Sub Category</button>
                        </div>
                </form>
            </div>
...
<div class="col-md-2 "><a onclick="return confirm('Are You Sure To Delete')" href="{{url('delete_sub_category',$subcategories->id)}}" class="btn btn-danger">Delete</a></div>
