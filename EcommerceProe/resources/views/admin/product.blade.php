          ...
          @endif
            <div class="div_center">
              ...
              <label>Product Title :</label>
                    <input class="input_color" type="text" id="title" name="title" placeholder="Write A Title" required>
              ...
              <label>Product Discount Price :</label>
                    <input class="input_color" type="number" name="discount_price" placeholder="Write Product Discount Price If Apply" >
